...
See [AGENTS.md](./AGENTS.md) for commands and architecture constraints. The Managed Agent design
documents under `docs/Managed Agent 系统架构/` are the source of truth.
